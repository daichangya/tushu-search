...
from tushu.fetcher.cache import get_the_latest_chapter
                ...
                if books_url:
                    ...
                    for i in books_url:
                        ...
                        if latest_data:
                            ...
                            item_result['tushu_content_url'] = get_latest_data.get('tushu_content_url', '')
                        item_result['add_time'] = i.get('add_time', '')
        ...
        try:
            ...
            if books_url:
                ...
                for i in books_url:
                    ...
                    item_result["last_read_chapter_name"] = last_read_chapter_name
                    result.append(item_result)
                return template('search_user.html', title='{name}的书架 - tushu'.format(name=name),
                                is_login=1,
                                user=user,
                                username=name,
                                is_bookmark=1,
