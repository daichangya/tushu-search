...
from tushu.utils import get_real_answer
from tushu.config import CONFIG, LOGGER
...
# jinjia2 config
env = Environment(
    # loader=PackageLoader('tushu.views.operate_blueprint', '../templates/operate'),
...
async def tushu_add_book(request):
    """
    添加书架
    :param request:
    :return:
...
async def tushu_add_bookmark(request):
    """
    添加书签
    :param request:
    :return:
...
async def tushu_delete_book(request):
    """
    删除书架
    :param request:
    :return:
...
async def tushu_delete_bookmark(request):
    """
    删除书签
    :param request:
    :return:
...
async def tushu_logout(request):
    """
    用户登出
    :param request:
    :return:
